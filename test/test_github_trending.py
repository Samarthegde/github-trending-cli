...
class TestGithubTrending(unittest.TestCase):
    ...
    def test_get_trending_repos(self):
        ...
        self.assertEqual(data.TRENDING_REPO_COUNT, len(repos)) # Check if the count is as expected
    ...
    def test_get_trending_devs(self):
        ...
        self.assertEqual(data.TRENDING_DEV_COUNT, len(devs)) # Check if the count is as expected
...
class GithubTrendingCliTest(unittest.TestCase):
    ...
    def test_github_trending_with_no_args(self):
        ...
        self.assertRegex(result.output, r'\033]8;;https://github.com/[\w\d\-/]+\033\\[\w\d\-/]+\033]8;;\033\\')
    ...
    def test_github_trending_with_repo_as_args(self):
        ...
        self.assertRegex(result.output, r'\.{3}') # Checks for "..." anywhere in the output
        # Check for hyperlinks in output
        self.assertRegex(result.output, r'\033]8;;https://github.com/[\w\d\-/]+\033\\[\w\d\-/]+\033]8;;\033\\')
